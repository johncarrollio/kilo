...
kilo.controller("InitController", function($scope, $localStorage, $location, $ionicLoading, $rootScope, $ionicPopup, $window, GetUserUUID, Alerts, SessionToken) {
    $scope.init = function() {

            $localStorage.uuid = 123345;
                ...
                SessionToken.getToken() 
                    ...
                    .then(function(data) {
                        ...
                        if($localStorage.hasOwnProperty("uuid") == true) {
                                /* Let's attempt to get the user from the DB */
                        ...
                        /* We couldn't get a valid session_id, SessionToken service will display an alert */
                        $ionicLoading.hide();
